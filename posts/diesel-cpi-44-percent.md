...
- **Reach is not magnitude.** 44.4% means diesel is an input cost somewhere inside categories worth 44.4% of the basket. It does not mean diesel drives 44.4% of inflation. Weight each category by how much of its delivered cost is actually diesel — calibrated against USDA's food dollar accounts, which put transportation at 3.5 cents and energy at 4.3 cents of every food dollar, and ATRI's trucking survey, which puts fuel at 20.6% of what it costs to run a truck — and diesel's embedded cost comes to roughly **0.8% of the index**. That is under a third of gasoline's entire direct weight, spread across 60 categories rather than sitting in one box. Diesel's case here rests on breadth, not on being the bigger number.
...
44.4% of the Consumer Price Index sits in a category diesel reaches as an input cost. That is a measure of breadth, not of magnitude: it means diesel is one cost among many inside categories worth 44.4% of the basket, not that diesel drives 44.4% of inflation. Weighting each category by how much of its delivered cost is actually diesel — anchored to USDA's food dollar accounts and ATRI's trucking cost survey — puts the embedded cost near 0.8% of the index, under a third of gasoline's 2.9% direct weight. The point is not that diesel is the larger cost. It is that gasoline is one visible line item while diesel is buried inside 60 of the 81 categories the index is built from.
