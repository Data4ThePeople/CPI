...
hero: cpi-diesel-billboard-1680x1080.jpg
...
- **Reach is not magnitude.** 44.4% means diesel is an input cost somewhere inside categories worth 44.4% of the basket. It does not mean diesel drives 44.4% of inflation, and it is not a claim that diesel's impact is bigger than gasoline's. Gasoline's 2.9% is a price households pay directly and can see. Diesel's 44.4% is a count of where it reaches. How hard a diesel move actually pushes on any one of those categories depends on what freight costs inside it, on contracts, inventory and margins — that is a different question, and this map does not answer it.
...
44.4% of the Consumer Price Index sits in a category diesel reaches as an input cost. That is a statement about breadth, and only about breadth. It means diesel shows up somewhere in the cost of things Americans spend 44.4% of their money on. It does not mean diesel drives 44.4% of inflation, and it does not mean diesel's impact is larger than gasoline's. How much a diesel move actually pushes on a given price depends on what freight costs inside that item, and on contracts, inventory and retail margins that absorb some of it first. That varies enormously between a sack of pet food and a hospital stay, and it is not quantified here. What is being claimed is reach: gasoline is one visible line item, and diesel is somewhere inside 60 of the 81 categories the index is built from.
